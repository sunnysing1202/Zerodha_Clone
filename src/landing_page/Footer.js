    ...
    <div className="container mt-5 footer">
      <div className="row mt-5">
        <div className="col-lg-3 col-sm-12 mt-3">
          <img src="media/images/logo.svg" alt="logo" className="f-logo" />
          <p className="mt-3">&copy; 2010 - 2024, Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        ...
        <div className="col-lg-3 col-sm-12 mt-5">
          <p>Account</p>
          <a href="" className="f-anchor">Open an account</a>
          <br />
          <a href="" className="f-anchor">Fund transfer</a>
          <br />
        </div>
      </div>

        <div className="mt-5 text-muted f-terms">
